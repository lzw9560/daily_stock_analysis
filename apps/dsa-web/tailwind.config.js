    ...
    extend: {
      colors: {
        ...
        purple: {
          ...
          dim: 'hsl(var(--color-purple-dim))',
          glow: 'hsl(var(--color-purple-glow))',
        },
        success: {
        ...
        'overlay-hover': 'hsl(var(--overlay-hover) / 0.05)',
        'overlay-selected': 'hsl(var(--overlay-selected) / 0.1)',
      },
      borderColor: {
        dim: 'hsl(var(--foreground) / 0.06)',
        subtle: 'hsl(var(--foreground) / 0.08)',
        'subtle-hover': 'hsl(var(--foreground) / 0.15)',
      },
      backgroundColor: {
        subtle: 'hsl(var(--foreground) / 0.05)',
        'subtle-hover': 'hsl(var(--foreground) / 0.1)',
        'subtle-soft': 'hsl(var(--foreground) / 0.03)',
        'subtle-active': 'hsl(var(--foreground) / 0.15)',
      },
      backgroundImage: {
      ...
      boxShadow: {
        'soft-card': 'var(--shadow-md)',
        'soft-card-strong': 'var(--shadow-lg)',
