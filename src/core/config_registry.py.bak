...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "FACTOR_PIPELINE_ENABLED": {
        ...
        "docs": [
            {
                "label": "Phase 2 路线图",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/roadmap.md",
            },
        ],
    },
    "FACTOR_PIPELINE_TRAIN_DAYS": {
    ...
    "FACTOR_PIPELINE_SHAP_SAMPLE_SIZE": {
    ...
    "AGNES_API_KEY": {
        "title": "Agnes API Key",
        "description": "API key for Agnes AI service (OpenAI-compatible). When set, auto-falls back to OPENAI_API_KEY if OPENAI_API_KEY is empty.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
