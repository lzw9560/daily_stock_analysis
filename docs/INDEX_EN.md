...
| [Phase Roadmap](roadmap_EN.md) | Phase 1 vectorized backtesting, Phase 2 multi-factor stock selection, Phase 3 agent debate, Phase 4 Monte Carlo + atomic execution |
